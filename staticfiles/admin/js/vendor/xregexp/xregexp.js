...
/**
 * Adds support for the `\p{L}` or `\p{Letter}` Unicode categorys. Addon packages for other Unicode
...
/* Adds data for the Unicode `Letter` categorys. Addon packages include other categories, scripts,
